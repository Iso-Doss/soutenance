...
header("location: index.php?profile=administrateur&ressource=ajouter-salle&message=$message&erreur=$erreur&erreurs=" . json_encode($erreurs) . "&donnees=" . json_encode($donnees));
